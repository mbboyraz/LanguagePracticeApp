...
public class LanguageAppService extends Service implements ValueEventListener {
    private static final String FIREBASE_URL = Resources.getSystem().getString(R.string.firebaseLink);
    Context context;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (mUsername == null) {
            ...
            mRef = new Firebase(Resources.getSystem().getString(R.string.firebaseLink) + "/chat/" + mUsername);
